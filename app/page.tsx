    ...
    <div className="relative container mx-auto p-5 h-[100vh] flex justify-center items-center">
      <div>
        ...
        <div className="text-xl lg:w-[50%] mt-10">
          StretchRopeEffect is a dynamic and interactive rope-like line effect created by ShilpAgency. This effect makes the line stretch when moused over, providing a visually engaging and unique user experience.
        </div>
